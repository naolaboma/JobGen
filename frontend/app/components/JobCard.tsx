...
const JobCard = ({ title, description, company_name, location,apply_url, percentage}: JobProps) => {
//   let colorClass = '';
//   if (percentage <= 40) {
  ...
  return (
    <div className="max-w-2xl mb-5 border rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
      <div className="p-4">
        ...
        <a href={apply_url} className="text-[#7BBFB3] hover:underline" target="_blank" rel="noopener noreferrer">Apply Now</a>
